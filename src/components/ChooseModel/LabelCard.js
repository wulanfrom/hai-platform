...
export default function LabelCard(props) {
    ...
    function uploadImage(img) {
        return new Promise((resolve, reject) => {
            const url = 'http://172.10.6.40:1289/poll/upload_image/'; //for signing in
    ...
    function getImageLabel(imageID) {
        return new Promise((resolve, reject) => {
            const url = 'http://172.10.6.40:1289/poll/get_image_label/'; //for signing in
            const data = {
                image_id: imageID,
            }
    ...
    useEffect(() => {
        if (!isUploaded) {
            uploadImage(data).then(res => {
                ...
                setImageURL("http://172.10.6.40:1289/static" + res.data.image);
    ...
    function updateUserLabelAnnotation(imageID, flag) {
        const url = 'http://172.10.6.40:1289/poll/update_label_annotation/'; //for signing in
        const data = {
            image_id: imageID,
