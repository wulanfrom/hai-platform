...
export default function TableBody(props) {
    ...
    function getLimeResult(imageID) {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/get_image_explanation/'; //for signing in
    ...
    function getUserNote(imageID) {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/get_user_explanation_note/'; //for signing in
            const data = {
                image_id: imageID,
            }
    ...
    function updateUserNote(imageID, user_note) {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/set_user_explanation_note/'; //for signing in
            const data = {
                image_id: imageID,
                user_note: user_note
            }
    ...
    function updateUserExplanationAnnotation(imageID, flag) {
        const url = 'http://15.165.96.51:1289/poll/update_explanation_annotation/'; //for signing in
        const data = {
            image_id: imageID,
