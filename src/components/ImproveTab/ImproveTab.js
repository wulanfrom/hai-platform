...
;
    ...
    function remove_Improvement(improvementID) {
        ...
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/remove_improvement/'; //for signing in
    ...
    function update_Improvement(improvementID, title, content) {
        ...
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/update_improvement/'; //for signing in
    ...
    function add_Improvement(title, content) {
        ...
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/add_improvement/'; //for signing in
    ...
    function setFigmaLink(figmaURL) {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/set_figma_link/'; //for signing in
    ...
    function get_Improvement() {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/get_improvement/'; //for signing in
    ...
    function getFigmaLink() {
        return new Promise((resolve, reject) => {
            const url = 'http://15.165.96.51:1289/poll/get_figma_link/'; //for signing in
